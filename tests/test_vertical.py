...
def test_get_call_debit_spread(option_values):
...
def test_get_put_debit_spread(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    spread_width = 30
    vertical_spread: Vertical = Vertical.get_vertical(option_chain=option_chain, expiration=expiration,
...
def test_get_call_credit_spread(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    spread_width = 30
    vertical_spread: Vertical = Vertical.get_vertical(option_chain=option_chain, expiration=expiration,
...
def test_get_put_credit_spread(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    spread_width = 30
    vertical_spread: Vertical = Vertical.get_vertical(option_chain=option_chain, expiration=expiration,
...
def test_vertical_spread_updates(option_values, spx_option_chain):
    expiration, strike1 = option_values
...
def test_credit_spread_required_margin(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    spread_width = 30
    vertical_spread: Vertical = Vertical.get_vertical(option_chain=option_chain, expiration=expiration,
...
def test_get_long_call_vertical_by_delta(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    long_delta = .26
    short_delta = .16
...
def test_get_short_call_vertical_by_delta(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
...
def test_get_long_put_vertical_by_delta(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    long_delta = .26
    short_delta = .16
...
def test_get_short_put_vertical_by_delta(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    short_delta = .26
    long_delta = .16
...
def test_long_call_spread_by_delta_and_strike(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    delta = .40
...
def test_SHORT_call_spread_by_delta_and_strike(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    delta = .40
...
def test_long_put_spread_by_delta_and_strike(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    delta = .40
...
def test_SHORT_put_spread_by_delta_and_strike(option_values):
    expiration, strike1 = option_values
    option_chain = MockSPXOptionChain()
    delta = .40
