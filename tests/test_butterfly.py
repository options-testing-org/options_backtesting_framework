...
def test_open_long_butterfly_position(option_chain):
    ...
    center_strike = 1990
    wing_width = 20
    position = Butterfly.get_butterfly_position(options=chain.option_chain, expiration=expiration, option_type=OptionType.PUT,
...
def test_long_butterfly_value(option_chain):
    ...
    center_strike = 1990
    wing_width = 20
    position = Butterfly.get_butterfly_position(options=chain.option_chain, expiration=expiration,
