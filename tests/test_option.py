...
# Test initialization
def test_option_init_with_only_option_contract_parameters(ticker,test_expiration):
    _id = 1
    strike = 100
...
def test_option_init_with_quote_data(ticker,test_expiration,test_quote_date):
    _id = 1
    strike = 100
...
def test_option_init_with_extended_properties(ticker,test_expiration,test_quote_date):
...
def test_option_init_with_user_defined_attributes(ticker,test_expiration,test_quote_date):
    _id = 1
    strike = 100
...
def test_option_init_raises_exception_if_missing_required_fields(ticker,test_expiration):
    # missing id
    _id = None
...
def test_option_init_raises_exception_if_quote_date_is_greater_than_expiration(ticker,test_expiration):
...
def test_update_sets_correct_values(get_test_call_option,test_update_quote_date):
    call = get_test_call_option
...
def test_open_trade_returns_correct_premium_value(get_test_call_option,get_test_put_option,option_type, quantity, expected_premium):
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
...
@pytest.mark.parametrize("quantity, incur_fees_flag, expected_fees", [(10, True, 5.0), (2, True, 1.0), (-3, True, 1.5),
                                                                      ...
                                                                      (-3, False, 0.0)])
def test_open_trade_sets_total_fees_when_incur_fees_flag_is_true(get_test_call_option,standard_fee,quantity, incur_fees_flag, expected_fees):
    test_option = get_test_call_option
...
def test_open_trade_when_there_is_no_quote_data_raises_exception(ticker,test_expiration):
...
def test_close_trade_closes_entire_position_with_default_values(get_test_call_option):
    test_option = get_test_call_option
    quantity = 10
    test_option.open_trade(quantity)
...
def test_close_partial_trade(get_test_call_option,quantity, close_quantity, remaining_quantity):
    test_option = get_test_call_option
    test_option.open_trade(quantity)
...
def test_close_trade_with_greater_than_quantity_open_raises_exception(get_test_call_option,open_quantity, close_quantity):
    test_option = get_test_call_option
...
def test_close_partial_trade_with_greater_than_remaining_quantity_raises_exception(get_test_call_option,open_qty, close1_qty, close2_qty):
    test_option = get_test_call_option
    test_option.open_trade(open_qty)
...
@pytest.mark.parametrize("incur_fees_flag, open_quantity, close_quantity, fee_amount", [(True, 10, 10, 5.0),
                                                                                        ...
                                                                                        (False, -10, -10, 0.0),
                                                                                        (False, -10, -2, 0.0)])
def test_close_trade_updates_total_fees_incur_fees_flag(get_test_call_option,standard_fee,incur_fees_flag, open_quantity, close_quantity, fee_amount):
    test_option = get_test_call_option
    test_option.fee_per_contract = standard_fee
...
@pytest.mark.parametrize("open_qty, close_qty, expected_qty, close_dt, close_pnl, close_pnl_pct, close_fees", [
    (10, 10, -10,None, 8_500.0, 5.6667, 5.0),
    (-10, -10, 10,None, -8_500.0, -5.6667, 5.0),
    (10, 1, -1,None, 850.0, 5.6667, 0.5),
    (-10, -5, 5,None, -4_250.0, -5.6667, 2.5)
    ])
def test_close_trade_values_with_one_close_trade(get_test_call_option,standard_fee,get_test_call_option_update_values_1,open_qty, close_qty, expected_qty, close_dt, close_pnl,
...
def test_put_option_close_trade_values_with_multiple_close_trades(test_update_quote_date2,get_test_put_option,get_test_put_option_update_values_1,get_test_put_option_update_values_2,standard_fee,open_qty, cqty1, cqty2, close_price,
...
def test_trade_close_records_returns_all_close_trades(get_test_call_option,get_test_call_option_update_values_1,get_test_call_option_update_values_2):
    test_option = get_test_call_option
...
def test_total_fees_returns_all_fees_incurred(ticker,test_expiration,test_quote_date,standard_fee,get_test_call_option_update_values_1):
...
def test_get_close_price_on_option_that_has_not_been_traded_raises_exception(get_test_call_option, get_test_call_option_update_values_1):
    test_option = get_test_call_option
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_closing_price_on_call_option_when_bid_is_zero(open_qty, expected_closing_price, get_test_call_option, get_test_call_option_update_values_1, get_test_call_option_update_values_3):
    test_option = get_test_call_option
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_closing_price_on_put_option_when_bid_is_zero(open_qty, expected_closing_price, get_test_put_option, get_test_put_option_update_values_1, get_test_put_option_update_values_3):
    test_option = get_test_put_option
    quote_date, spot_price, bid, ask, price = get_test_put_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_call_option_get_close_price_is_zero_when_option_expires_otm(get_test_put_option,get_test_put_option_update_values_3,at_expiration_quote_date):
    test_option = get_test_put_option
    test_option.open_trade(1)
...
def test_put_option_get_close_price_is_zero_when_option_expires_otm(get_test_put_option,get_test_put_option_update_values_3,at_expiration_quote_date):
    test_option = get_test_put_option
    test_option.open_trade(1)
    _, spot_price, bid, ask, price = get_test_put_option_update_values_3
    test_option.update(at_expiration_quote_date, spot_price, bid, ask, price)
...
def test_dte_is_none_when_option_does_not_have_quote_data(ticker,test_expiration):
    test_option = Option(1, ticker, 100, test_expiration, OptionType.CALL)
...
def test_otm_and_itm_equal_none_when_option_does_not_have_quote_data(ticker,test_expiration):
    test_option = Option(1, ticker, 100, test_expiration, OptionType.CALL)
...
def test_call_option_otm(ticker,test_expiration,test_quote_date,option_type, spot_price, strike, expected_value):
...
def test_call_option_itm(ticker,test_expiration,test_quote_date,option_type, spot_price, strike, expected_value):
    bid, ask, price = (9.50, 10.5, 10.00)
    test_option = Option(1, ticker, 100, test_expiration, option_type,
                         quote_date=test_quote_date, spot_price=spot_price, bid=bid, ask=ask, price=price)
...
def test_is_expired_returns_none_when_no_quote_data(ticker,test_expiration):
    test_option = Option(1, ticker, 100, test_expiration, OptionType.CALL)
...
def test_is_expired_returns_correct_result(get_test_call_option,ticker,get_test_put_option_update_values_1,expiration_date_test, quote_date, expected_result):
    test_option = get_test_call_option
...
def test_is_trade_open_returns_false_if_no_trade_was_opened(get_test_call_option):
    test_option = get_test_call_option
    expected_result = False
    assert test_option.is_trade_open() == expected_result


def test_is_trade_open_returns_true_if_trade_was_opened(get_test_call_option):
    test_option = get_test_call_option
    test_option.open_trade(10)
...
def test_is_trade_open_returns_true_if_trade_was_opened_and_partially_closed(get_test_call_option):
    test_option = get_test_call_option
    test_option.open_trade(10)
...
def test_is_trade_open_returns_false_if_trade_was_opened_and_then_closed(get_test_call_option):
    test_option = get_test_call_option
    test_option.open_trade(10)
...
def test_get_open_profit_loss_raises_exception_if_trade_was_not_opened(get_test_call_option):
    test_option = get_test_call_option
...
def test_get_open_profit_loss_is_zero_if_quote_data_is_not_updated(get_test_call_option):
    test_option = get_test_call_option
    test_option.open_trade(10)
...
def test_get_open_profit_loss_is_zero_when_no_contracts_are_open(get_test_call_option,get_test_call_option_update_values_1):
    test_option = get_test_call_option
    test_option.open_trade(10)
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_open_profit_loss_value(get_test_call_option,get_test_put_option,get_test_call_option_update_values_1,option_type, quantity, price, expected_profit_loss):
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
    test_option.open_trade(quantity)
...
def test_get_open_profit_loss_percent_raises_exception_if_trade_was_not_opened(get_test_call_option):
    test_option = get_test_call_option
...
def test_get_profit_loss_percent_return_zero_when_no_contracts_are_open(get_test_call_option):
    test_option = get_test_call_option
    test_option.open_trade(1)
...
def test_get_profit_loss_percent_value(get_test_call_option,get_test_put_option,get_test_call_option_update_values_1,option_type, quantity, price, expected_profit_loss_pct):
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
    test_option.open_trade(quantity)
    quote_date, spot_price, bid, ask, _ = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_days_in_trade(get_test_call_option_update_values_1,get_test_call_option,quote_date, expected_days_in_trade):
    test_option = get_test_call_option
    test_option.open_trade(1)
...
def test_get_total_profit_loss_raises_exception_if_not_traded(get_test_call_option):
    test_option = get_test_call_option
...
def test_get_total_profit_loss_returns_unrealized_when_no_contracts_are_closed(get_test_call_option,get_test_put_option,get_test_call_option_update_values_1,option_type, qty, price, expected_value):
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
...
def test_get_total_profit_loss_returns_closed_pnl_when_all_contracts_are_closed(get_test_call_option,get_test_call_option_update_values_1):
    test_option = get_test_call_option
    test_option.open_trade(10)
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_total_profit_loss_returns_unrealized_and_closed_pnl_when_partially_closed(get_test_call_option,get_test_call_option_update_values_1,get_test_call_option_update_values_2):
    test_option = get_test_call_option
    test_option.open_trade(10)
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_total_profit_loss_returns_unrealized_and_closed_pnl_when_multiple_close_trades(get_test_call_option,get_test_call_option_update_values_1,get_test_call_option_update_values_2):
    test_option = get_test_call_option
    test_option.open_trade(10)
    quote_date, spot_price, bid, ask, price = get_test_call_option_update_values_1
    test_option.update(quote_date, spot_price, bid, ask, price)
...
def test_get_total_profit_loss_percent_raises_exception_if_not_traded(get_test_call_option):
    test_option = get_test_call_option
...
def test_get_total_profit_loss_percent_returns_unrealized_when_no_contracts_are_closed(
        get_test_call_option,get_test_put_option,get_test_call_option_update_values_1,option_type, qty, price, expected_value):    
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
    test_option.open_trade(qty)
...
def test_get_total_profit_loss_percent_returns_closed_pnl_when_all_contracts_are_closed(get_test_call_option,get_test_put_option,get_test_call_option_update_values_1,option_type, qty, price,
                                                                                        expected_value):
    test_option = get_test_call_option if option_type == OptionType.CALL else get_test_put_option
    test_option.open_trade(qty)
    quote_date, spot_price, bid, ask, _ = get_test_call_option_update_values_1
...
def test_get_total_profit_loss_percent_returns_unrealized_and_closed_pnl_when_multiple_close_trades(get_test_call_option,get_test_call_option_update_values_1,get_test_call_option_update_values_2, qty,
                                                                                                    close_qty_1,
                                                                                                    close_qty_2,
                                                                                                    price1, price2,
                                                                                                    price3,
...
def test_single_option_properties_return_none_when_property_group_is_none(ticker,test_expiration):
